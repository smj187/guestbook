<template>
    <div class="flex space-x-3 flex-wrap gap-y-3">
        ...
        <div class="flex space-x-1">
            <PopoverMenu :buttonName="'Format'" :selectedFormat="selectedFormat" :formats="formats"
                @applySelection="updateSelectedFormat" />

            <PopoverMenu staticIcon="M13 6V21H11V6H5V4H19V6H13Z" :buttonName="'Font'" :selectedFormat="selectedFont"
                :formats="fonts" @applySelection="updateSelectedFont" />
        </div>

        <div class="flex space-x-1 items-center">
            <button type="button" title="reduce font size" @click="decreaseFontSize"
                class="disabled:cursor-default disabled:opacity-25 fill-slate-600 bg-white hover:bg-slate-50 focus:ring-2 focus:outline-none focus:ring-slate-600 font-medium rounded text-sm p-2.5 text-center inline-flex items-center">
            ...
            <input type="text" class="w-10 font-semibold h-10 text-center text-slate-800 text-sm rounded-md cursor-default"
                v-model="fontSize" readonly />
            <button type="button" title="increase font size'" @click="increaseFontSize"
                class="disabled:cursor-default disabled:opacity-25 fill-slate-600 bg-white hover:bg-slate-50 focus:ring-2 focus:outline-none focus:ring-slate-600 font-medium rounded text-sm p-2.5 text-center inline-flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                    <path fill="none" d="M0 0h24v24H0z"></path>
        ...
        <div class="flex space-x-1">
            <button type="button" title="bold" @click="toggleBold" :class="isBold ? 'bg-slate-200' : ''"
                class="disabled:cursor-default disabled:opacity-25 fill-slate-600 bg-white hover:bg-slate-50 focus:ring-2 focus:outline-none focus:ring-slate-600 font-medium rounded text-sm p-2.5 text-center inline-flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                    <path fill="none" d="M0 0h24v24H0z"></path>
                    <path
            ...
            <button type="button" title="italic" @click="toggleItalic" :class="isItalic ? 'bg-slate-200' : ''"
                class="disabled:cursor-default disabled:opacity-25 fill-slate-600 bg-white hover:bg-slate-50 focus:ring-2 focus:outline-none focus:ring-slate-600 font-medium rounded text-sm p-2.5 text-center inline-flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                    <path fill="none" d="M0 0h24v24H0z"></path>
            ...
            <button type="button" title="underline" @click="toggleUnderline" :class="isUnderline ? 'bg-slate-200' : ''"
                class="disabled:cursor-default disabled:opacity-25 fill-slate-600 bg-white hover:bg-slate-50 focus:ring-2 focus:outline-none focus:ring-slate-600 font-medium rounded text-sm p-2.5 text-center inline-flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                    <path fill="none" d="M0 0h24v24H0z"></path>
                    <path
...
watch(blockType, () => {
    const format = formats.find((format) => format.value === blockType.value);
    if (format) {
...
function updateSelectedFormat(value: string) {
    const format = formats.find((format) => format.value === value);
    if (format) {
        selectedFormat.value = format;
